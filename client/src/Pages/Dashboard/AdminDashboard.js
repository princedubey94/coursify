...
const AdminDashboard = () => {
  ...
  return (
    <Layout>
      <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-black bg-white">
        ...
        <div className="mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
          <div className="flex w-full items-center justify-between">
            ...
            <button
              ...
              className="w-fit bg-yellow-500 text-white hover:bg-yellow-600 transition-all ease-in-out duration-300 rounded py-2 px-4 font-semibold text-lg cursor-pointer"
            >
              Create New Course
            </button>
          </div>

          <table className="table overflow-x-scroll  text-green-500 ">
            <thead>
              <tr>
                <th>S No.</th>
                <th>Course Title</th>
            ...
            <tbody>
              {myCourses?.map((element, index) => {
                return (
                  <tr  key={element?._id} className="py-0">
                    ...
                    <td className="h-20">{element?.category}</td>
                    <td className="h-20">{element?.createdBy}</td>
                    <td className="h-20">{element?.numberOfLectures}</td>
                    <td className="max-w-28 overflow-hidden h-0 p-0 text-ellipsis whitespace-nowrap">
                      <textarea
                        readOnly
                        className="w-80 h-4/6	 bg-transparent resize-none py-0"
                        value={element?.description}
                      ></textarea>
                    </td>

                    <td className="flex items-center gap-4 h-20">
                      {/* to edit the course */}
                      <button
                        onClick={() =>
                          navigate("/course/create", {
                        ...
                        className="bg-yellow-500 h-10 text-white hover:bg-yellow-600 transition-all ease-in-out duration-300 text-xl py-2 px-4 rounded-md font-bold"
                      >
                        <MdOutlineModeEdit />
                      </button>
                      ...
                      <button
                        ...
                        className="bg-red-500 text-white hover:bg-red-600 transition-all ease-in-out duration-30 text-xl py-2 px-4 rounded-md font-bold"
                      >
                        <BsTrash />
                      </button>
                      ...
                      <button
                        ...
                        className="bg-green-500 text-white hover:bg-green-600 transition-all ease-in-out duration-30 text-xl py-2 px-4 rounded-md font-bold"
                      >
