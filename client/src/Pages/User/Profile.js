  ...
  return (
    <Layout>
      <div className="min-h-[90vh] flex items-center justify-center">
        <div className="my-10 flex flex-col gap-4 rounded-lg p-4 text-white w-1/4 h-100 shadow-[0_0_10px_black] overflow-hidden">
          <img
          ...
          <div className="flex items-center justify-between gap-2">
            <Link
              ...
              className="w-1/2 bg-yellow-600 hover:bg-yellow-700 transition-all ease-in-out duration-300 rounded-sm py-2 px-0 font-semibold cursor-pointer text-center"
            >
